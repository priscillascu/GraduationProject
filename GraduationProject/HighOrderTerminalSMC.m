...
%0时刻的误差值e0
% if t == 0
%     e0 = th'- [1; 1; 1; 1; 1; 1];  %0时刻的误差为th - cos(0) = th
%     de0 = dth';  %0时刻的误差一阶导数为dth - cos(0) = dth - 1
%     dde0 = ddth' + [0.25; 0.25; 1; 1; 1; 1];  %0时刻的误差二阶导数为ddth + sin(0) = th
% end
e0 = [-1; -1; -1; -1; -1; -1];
de0 = [0; 0; 0; 0; 0; 0];
dde0 = [0.25; 0.25; 1; 1; 1; 1];
%P算子中的系数a
T = 0.5;
a00 = -10;
a10 = 15;
