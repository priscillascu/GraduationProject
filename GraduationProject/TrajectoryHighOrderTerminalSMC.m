function [sys,x0,str,ts] = TrajectoryHighOrderTerminalSMC(t, x, u, flag)
switch flag,
  case 0,
...
R = [R1; R2; R3; R4; R5; R6];
%位置给定的导数，即速度
dR1 = (0.2122)*(0.07145)*cos((0.07145)*t + (-0.2929)) + (0.02808)*(0.4551)*cos((0.4551)*t + (-0.6885)) + (0.03361)*(0.3328)*cos((0.3328)*t + (3.262)) + (0.08461)*(0.2392)*cos((0.2392)*t + (-4.276)) + (0.003794)*(0.7906)*cos((0.7906)*t + (0.9682)) + (0.004144)*(0.6226)*cos((0.6226)*t + (3.124)) + (0.001227)*(1.399)*cos((1.399)*t + (1.31));
dR2 = (0.03998)*(0.1579)*cos((0.1579)*t + (-2.991)) + (0.01384)*(0.07885)*cos((0.07885)*t + (3.067)) + (0.008931)*(0.4724)*cos((0.4724)*t + (-0.04673)) + (0.005905)*(0.6298)*cos((0.6298)*t + (1.467)) + (0.001464)*(0.7873)*cos((0.7873)*t + (0.2315)) + (0.0009553)*(0.3137)*cos((0.3137)*t + (-2.039)) + (0.0005246)*(1.102)*cos((1.102)*t + (0.4585));
dR3 = (0.2901)*(0.07293)*cos((0.07293)*t + (0.4957)) + (0.04641)*(0.4405)*cos((0.4405)*t + (-1.95)) + (0.09683)*(0.2138)*cos((0.2138)*t + (4.767)) + (-0.001061)*(0.8705)*cos((0.8705)*t + (-8.062)) + (0.007977)*(0.7422)*cos((0.7422)*t + (3.05)) + (-0.001536)*(1.419)*cos((1.419)*t + (-7)) + (-0.002239)*(1.108)*cos((1.108)*t + (-5.639));
dR4 =  (0.9324)*(0.06601)*cos((0.06601)*t + (-0.323)) + (0.7436)*(0.2437)*cos((0.2437)*t + (1.239)) + (0.6775)*(0.3191)*cos((0.3191)*t + (-3.114)) + (0.4589)*(0.5866)*cos((0.5866)*t + (-1.384)) + (0.2406)*(0.4374)*cos((0.4374)*t + (-1.809)) + (0.3416)*(0.6084)*cos((0.6084)*t + (1.528)) + (0.007143)*(0.935)*cos((0.935)*t + (-1.08));
dR5 =  (0.3727)*(0.07814)*cos((0.07814)*t + (-3.077)) + (0.02052)*(0.4522)*cos((0.4522)*t + (1.43)) + (0.01501)*(0.2963)*cos((0.2963)*t + (0.6598)) + (0.06308)*(0.6122)*cos((0.6122)*t + (-0.8979)) + (0.04859)*(0.6365)*cos((0.6365)*t + (1.819)) + (-0.001081)*(0.8956)*cos((0.8956)*t + (0.05527)) + (0.001443)*(1.386)*cos((1.386)*t + (-0.7095));
dR6 =  (0.9288)*(0.06625)*cos((0.06625)*t + (2.786)) + (0.7397)*(0.2484)*cos((0.2484)*t + (-2.053)) + (0.9237)*(0.3339)*cos((0.3339)*t + (-0.2747)) + (0.1309)*(0.5835)*cos((0.5835)*t + (1.343)) + (0.4342)*(0.3898)*cos((0.3898)*t + (1.979)) + (0.04266)*(0.6936)*cos((0.6936)*t + (3.03)) + (0.009599)*(0.9341)*cos((0.9341)*t + (1.875));

dR = [dR1; dR2; dR3; dR4; dR5; dR6];
%位置给定的二阶导数，即加速度
ddR1 = -(0.2122)*(0.07145)^2*sin((0.07145)*t + (-0.2929)) + -(0.02808)*(0.4551)^2*sin((0.4551)*t + (-0.6885)) + -(0.03361)*(0.3328)^2*sin((0.3328)*t + (3.262)) + -(0.08461)*(0.2392)^2*sin((0.2392)*t + (-4.276)) + -(0.003794)*(0.7906)^2*sin((0.7906)*t + (0.9682)) + -(0.004144)*(0.6226)^2*sin((0.6226)*t + (3.124)) + -(0.001227)*(1.399)^2*sin((1.399)*t + (1.31));
ddR2 = -(0.03998)*(0.1579)^2*sin((0.1579)*t + (-2.991)) + -(0.01384)*(0.07885)^2*sin((0.07885)*t + (3.067)) + -(0.008931)*(0.4724)^2*sin((0.4724)*t + (-0.04673)) + -(0.005905)*(0.6298)^2*sin((0.6298)*t + (1.467)) + -(0.001464)*(0.7873)^2*sin((0.7873)*t + (0.2315)) + -(0.0009553)*(0.3137)^2*sin((0.3137)*t + (-2.039)) + -(0.0005246)*(1.102)^2*sin((1.102)*t + (0.4585));
ddR3 = -(0.2901)*(0.07293)^2*sin((0.07293)*t + (0.4957)) + -(0.04641)*(0.4405)^2*sin((0.4405)*t + (-1.95)) + -(0.09683)*(0.2138)^2*sin((0.2138)*t + (4.767)) + -(-0.001061)*(0.8705)^2*sin((0.8705)*t + (-8.062)) + -(0.007977)*(0.7422)^2*sin((0.7422)*t + (3.05)) + -(-0.001536)*(1.419)^2*sin((1.419)*t + (-7)) + -(-0.002239)*(1.108)^2*sin((1.108)*t + (-5.639));
ddR4 = -(0.9324)*(0.06601)^2*sin((0.06601)*t + (-0.323)) + -(0.7436)*(0.2437)^2*sin((0.2437)*t + (1.239)) + -(0.6775)*(0.3191)^2*sin((0.3191)*t + (-3.114)) + -(0.4589)*(0.5866)^2*sin((0.5866)*t + (-1.384)) + -(0.2406)*(0.4374)^2*sin((0.4374)*t + (-1.809)) + -(0.3416)*(0.6084)^2*sin((0.6084)*t + (1.528)) + -(0.007143)*(0.935)^2*sin((0.935)*t + (-1.08));
ddR5 = -(0.3727)*(0.07814)^2*sin((0.07814)*t + (-3.077)) + -(0.02052)*(0.4522)^2*sin((0.4522)*t + (1.43)) + -(0.01501)*(0.2963)^2*sin((0.2963)*t + (0.6598)) + -(0.06308)*(0.6122)^2*sin((0.6122)*t + (-0.8979)) + -(0.04859)*(0.6365)^2*sin((0.6365)*t + (1.819)) + -(-0.001081)*(0.8956)^2*sin((0.8956)*t + (0.05527)) + -(0.001443)*(1.386)^2*sin((1.386)*t + (-0.7095));
ddR6 = -(0.9288)*(0.06625)^2*sin((0.06625)*t + (2.786)) + -(0.7397)*(0.2484)^2*sin((0.2484)*t + (-2.053)) + -(0.9237)*(0.3339)^2*sin((0.3339)*t + (-0.2747)) + -(0.1309)*(0.5835)^2*sin((0.5835)*t + (1.343)) + -(0.4342)*(0.3898)^2*sin((0.3898)*t + (1.979)) + -(0.04266)*(0.6936)^2*sin((0.6936)*t + (3.03)) + -(0.009599)*(0.9341)^2*sin((0.9341)*t + (1.875));
